...
class MtxSelect extends _MtxSelectMixinBase {
    ...
    constructor(_changeDetectorRef, _elementRef, _focusMonitor, _defaultErrorStateMatcher, _parentForm, _parentFormGroup, ngControl, _parentFormField, _defaultOptions) {
        ...
        this.addTag = false;
        this.addTagText = (_b = (_a = this._defaultOptions) === null || _a === void 0 ? void 0 : _a.addTagText) !== null && _b !== void 0 ? _b : 'Add item';
        this.appearance = 'underline';
        this.appendTo = (_d = (_c = this._defaultOptions) === null || _c === void 0 ? void 0 : _c.appendTo) !== null && _d !== void 0 ? _d : 'body';
        this.bindLabel = (_e = this._defaultOptions) === null || _e === void 0 ? void 0 : _e.bindLabel;
        this.bindValue = (_f = this._defaultOptions) === null || _f === void 0 ? void 0 : _f.bindValue;
        this.closeOnSelect = true;
        this.clearAllText = (_h = (_g = this._defaultOptions) === null || _g === void 0 ? void 0 : _g.clearAllText) !== null && _h !== void 0 ? _h : 'Clear all';
        this.clearable = true;
        ...
        this.loading = false;
        this.loadingText = (_k = (_j = this._defaultOptions) === null || _j === void 0 ? void 0 : _j.loadingText) !== null && _k !== void 0 ? _k : 'Loading...';
        this.labelForId = null;
        this.markFirst = true;
        this.multiple = false;
        this.notFoundText = (_m = (_l = this._defaultOptions) === null || _l === void 0 ? void 0 : _l.notFoundText) !== null && _m !== void 0 ? _m : 'No items found';
        ...
        this.trackByFn = null;
        this.inputAttrs = {};
        this.openOnEnter = (_p = (_o = this._defaultOptions) === null || _o === void 0 ? void 0 : _o.openOnEnter) !== null && _p !== void 0 ? _p : true;
        this.minTermLength = 0;
        this.editableSearchTerm = false;
        this.keyDownFn = (_) => true;
        this.virtualScroll = false;
        this.typeToSearchText = (_r = (_q = this._defaultOptions) === null || _q === void 0 ? void 0 : _q.typeToSearchText) !== null && _r !== void 0 ? _r : 'Type to search';
        ...
        this._clearSearchOnAdd = (_s = this._defaultOptions) === null || _s === void 0 ? void 0 : _s.clearSearchOnAdd;
        this._items = [];
        ...
        this._placeholder = (_t = this._defaultOptions) === null || _t === void 0 ? void 0 : _t.placeholder;
        this._focused = false;
