...
exports.LibraryDeleteAuthorsController = void 0;
...
let LibraryDeleteAuthorsController = class LibraryDeleteAuthorsController {
    constructor(handler) {
...
__decorate([
    (0, common_1.Delete)(),
    (0, swagger_1.ApiOperation)({ summary: 'Delete authors in batch according to query' }),
    (0, swagger_1.ApiOkResponse)({ description: 'The records has been deleted successfully.', type: [dto_1.LibraryAuthorDto] }),
...
], LibraryDeleteAuthorsController.prototype, "main", null);
LibraryDeleteAuthorsController = __decorate([
    (0, swagger_1.ApiTags)('[library] author'),
    (0, common_1.Controller)('library/authors/delete'),
    __metadata("design:paramtypes", [library_delete_authors_handler_1.LibraryDeleteAuthorsHandler])
], LibraryDeleteAuthorsController);
exports.LibraryDeleteAuthorsController = LibraryDeleteAuthorsController;
//# sourceMappingURL=library-delete-authors.controller.js.map