...
exports.LibraryFindBookResolver = void 0;
...
let LibraryFindBookResolver = class LibraryFindBookResolver {
    constructor(handler) {
...
__decorate([
    (0, graphql_1.Query)('libraryFindBook'),
...
], LibraryFindBookResolver.prototype, "main", null);
LibraryFindBookResolver = __decorate([
    (0, graphql_1.Resolver)(),
    __metadata("design:paramtypes", [library_find_book_handler_1.LibraryFindBookHandler])
], LibraryFindBookResolver);
exports.LibraryFindBookResolver = LibraryFindBookResolver;
//# sourceMappingURL=library-find-book.resolver.js.map