...
exports.UpdateAuthorByIdService = void 0;
...
let UpdateAuthorByIdService = class UpdateAuthorByIdService {
    ...
    async main(payload, constraint, cQMetadata) {
        ...
        authorRegister.updated(author);
        authorRegister.commit();
    }
};
UpdateAuthorByIdService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [cqrs_1.EventPublisher,
        author_repository_1.IAuthorRepository])
], UpdateAuthorByIdService);
exports.UpdateAuthorByIdService = UpdateAuthorByIdService;
//# sourceMappingURL=update-author-by-id.service.js.map