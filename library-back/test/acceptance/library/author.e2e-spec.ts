...
describe('author', () =>
{
    ...
    test('/REST:POST library/author/create - Got 400 Conflict, AuthorName is too large, has a maximum length of 50', () =>
    {
        return request(app.getHttpServer())
            .post('/library/author/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for AuthorName is too large, has a maximum length of 50');
            });
    });
